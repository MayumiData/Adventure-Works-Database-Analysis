...
the user specifies the Sales country. CREATE PROCEDURE SaleCountry @SalesTerritoryCountry nvarchar(50) AS 
BEGIN
  SELECT
    DimSalesTerritory.SalesTerritoryCountry,
    SUM(FactInternetSales.SalesAmount) AS SalesAmount 
...
CustomerGeography. CREATE PROCEDURE CustomerGeography AS 
BEGIN
...
CREATE PROCEDURE GetAverageProductSalesAmountUSD AS 
BEGIN
  SELECT
    DimProduct.EnglishProductName,
